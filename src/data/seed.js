...
function seedKb() {
  return [
    ...
    {
      id: 'kb-funnels', category: 'Воронки и сделки', emoji: '🗂️', title: 'Воронки и стадии', updatedAt: '',
    ...
    {
      id: 'kb-deal', category: 'Воронки и сделки', emoji: '📇', title: 'Карточка сделки', updatedAt: '',
    ...
    {
      id: 'kb-members', category: 'Воронки и сделки', emoji: '👨‍👩‍👧', title: 'Участники, родители и дети', updatedAt: '',
    ...
    {
      id: 'kb-builder', category: 'Документы', emoji: '🛠️', title: 'Конструктор документов (без Word)', updatedAt: '',
    ...
    {
      id: 'kb-tasks', category: 'Задачи', emoji: '✅', title: 'Дела и задачи', updatedAt: '',
